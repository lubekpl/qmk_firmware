...
[_QWERTY] = LAYOUT_planck_grid(
  ...
  MO(3),          KC_LCTL, KC_LALT,      KC_LGUI, MO(1),        KC_ENT,       KC_SPC, MO(2), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
				...
				KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_TRNS, KC_TRNS, MO(3), KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_RAISE] = LAYOUT_planck_grid(
				...
				KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(3), KC_TRNS, KC_TRNS, KC_NO, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
